...
with open("../data/processed/training/simulated/simulated_msa.txt", 'w') as file_handle:
    for node in t.traverse('preorder'):
...
with open("../data/processed/training/simulated/simulated_msa.pkl", 'wb') as file_handle:
